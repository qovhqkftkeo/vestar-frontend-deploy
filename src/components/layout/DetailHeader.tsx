...
const STATE_CLASSES: Record<ScrollState, string> = {
  default:
    'top-0 w-full max-w-[430px] h-14 bg-white/60 backdrop-blur-md border-b border-black/[0.07] px-4',
  hidden:
    '-top-[66px] w-full max-w-[430px] h-14 bg-white/60 backdrop-blur-md border-b border-black/[0.07] px-4',
  floating:
...
export function DetailHeader({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <span className="flex-1 text-[13px] font-semibold text-black/60 truncate">{title}</span>
