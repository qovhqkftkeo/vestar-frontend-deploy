...
export const INDEX_CACHE_KEY = `vestar-verification:index:v11:${VERIFICATION_FACTORY.toLowerCase()}`
export const DETAIL_CACHE_PREFIX = `vestar-verification:detail:v11:${VERIFICATION_FACTORY.toLowerCase()}:`
export const MANIFEST_CACHE_PREFIX = 'vestar-verification:manifest:v2:'
