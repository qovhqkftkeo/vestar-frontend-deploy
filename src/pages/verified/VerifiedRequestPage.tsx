    ...
    <div className="min-h-full bg-[#F7F8FA] px-5 py-6">
      <div className="rounded-[28px] bg-white p-5 shadow-[0_12px_32px_rgba(17,24,39,0.06)]">
        ...
        <p className="mt-2 text-[14px] leading-6 text-[#707070]">
          organizer 지갑 주소로 verified organizer 인증을 요청합니다. 관리자가 승인하면 해당 row가
          `VERIFIED` 상태로 갱신됩니다.
        </p>
        ...
        <button
          type="button"
          disabled={!isConnected || !address || !organizationName.trim() || isSubmitting || isLoading}
